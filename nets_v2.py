...
class ValueHead(nn.Module):
    def __init__(self, in_channels, out_channels=3, head_channels=32, value_channels=64):
        ...
        self.conv_win_pos = nn.Conv2d(head_channels, 1, kernel_size=1, bias=False)
        ...
        self.fc_steps = nn.Linear(value_channels, 1, bias=True)
    ...
    def forward(self, x):
        ...
        win_pos_logits = self.conv_win_pos(v)  # BCEWithLogitsLoss
        ...
        remaining_steps = self.softplus(self.fc_steps(out))
        return value_logits, win_pos_logits, remaining_steps
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        value_logits, win_pos_logits, remaining_steps = self.value_head(x)
        ...
        nn_output = {
            ...
            "win_pos_logits": win_pos_logits,  # [B, 1, H, W]
            "remaining_steps": remaining_steps,  # [B, 1]
        }
        return nn_output